...
impl McpApps {
    ...
    pub fn is_enabled_for(&self, app: &AppType) -> bool {
        match app {
            ...
            AppType::Tuzi => self.claude, // Tuzi shares Claude's MCP enablement
        }
    }
    ...
    pub fn set_enabled_for(&mut self, app: &AppType, enabled: bool) {
        match app {
            ...
            AppType::Tuzi => self.claude = enabled, // Tuzi shares Claude's MCP enablement
        }
    }
...
impl SkillApps {
    ...
    pub fn is_enabled_for(&self, app: &AppType) -> bool {
        match app {
            ...
            AppType::ClaudeDesktop => false,
            AppType::Tuzi => self.claude, // Tuzi shares Claude's skill enablement
        }
    }
    ...
    pub fn set_enabled_for(&mut self, app: &AppType, enabled: bool) {
        match app {
            ...
            AppType::Tuzi => self.claude = enabled, // Tuzi shares Claude's skill enablement
        }
    }
...
impl FromStr for AppType {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        match normalized.as_str() {
            ...
            "tuzi" => Ok(AppType::Tuzi),
            other => Err(AppError::localized(
                "unsupported_app",
                format!("不支持的应用标识: '{other}'。可选值: claude, claude-desktop, codex, gemini, opencode, openclaw, hermes, tuzi。"),
                format!("Unsupported app id: '{other}'. Allowed: claude, claude-desktop, codex, gemini, opencode, openclaw, hermes, tuzi."),
            )),
        }
    }
}
...
impl CommonConfigSnippets {
    ...
    pub fn get(&self, app: &AppType) -> Option<&String> {
        match app {
            ...
            AppType::Tuzi => self.claude.as_ref(), // Tuzi shares Claude's common config
        }
    }
    ...
    pub fn set(&mut self, app: &AppType, snippet: Option<String>) {
        match app {
            ...
            AppType::Tuzi => self.claude = snippet, // Tuzi shares Claude's common config
        }
    }
}
...
impl Default for MultiAppConfig {
    fn default() -> Self {
        ...
        apps.insert("tuzi".to_string(), ProviderManager::default());
...
impl MultiAppConfig {
    ...
    pub fn mcp_for(&self, app: &AppType) -> &McpConfig {
        match app {
            ...
            AppType::Tuzi => &self.mcp.claude, // Tuzi shares Claude's MCP config
        }
    }
    ...
    pub fn mcp_for_mut(&mut self, app: &AppType) -> &mut McpConfig {
        match app {
            ...
            AppType::Tuzi => &mut self.mcp.claude, // Tuzi shares Claude's MCP config
        }
    }
    ...
    fn default_with_auto_import() -> Result<Self, AppError> {
        ...
        Self::auto_import_prompt_if_exists(&mut config, AppType::Tuzi)?;
    ...
    fn auto_import_prompt_if_exists(config: &mut Self, app: AppType) -> Result<bool, AppError> {
        ...
        let prompts = match app {
            ...
            AppType::Tuzi => &mut config.prompts.claude.prompts, // Tuzi shares Claude's prompts
        };
    ...
    pub fn migrate_mcp_to_unified(&mut self) -> Result<bool, AppError> {
        ...
        for app in [
            ...
            let old_servers = match app {
                ...
                AppType::Tuzi => continue,     // Tuzi didn't exist in v3.6.x, skip
            };
