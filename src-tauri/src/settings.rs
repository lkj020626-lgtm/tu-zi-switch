...
impl VisibleApps {
    ...
    pub fn is_visible(&self, app: &AppType) -> bool {
        match app {
            ...
            AppType::Tuzi => true, // Tuzi is always visible when present
        }
    }
}
...
pub fn get_current_provider(app_type: &AppType) -> Option<String> {
    ...
    match app_type {
        ...
        AppType::Tuzi => settings.current_provider_claude.clone(), // Tuzi shares Claude's current provider
    }
}
...
pub fn set_current_provider(app_type: &AppType, id: Option<&str>) -> Result<(), AppError> {
    ...
    mutate_settings(|settings| match app_type {
        ...
        AppType::Tuzi => settings.current_provider_claude = id_owned.clone(), // Tuzi shares Claude's current provider
    })
}
