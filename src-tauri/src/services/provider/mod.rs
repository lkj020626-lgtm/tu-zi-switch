...
impl ProviderService {
    fn normalize_provider_if_claude(app_type: &AppType, provider: &mut Provider) {
        if matches!(app_type, AppType::Claude | AppType::Tuzi) {
    ...
    pub fn extract_common_config_snippet(
        ...
        match app_type {
            AppType::Claude | AppType::Tuzi => Self::extract_claude_common_config(&provider.settings_config),
    ...
    pub fn extract_common_config_snippet_from_settings(
        ...
        match app_type {
            AppType::Claude | AppType::Tuzi => Self::extract_claude_common_config(settings_config),
            AppType::ClaudeDesktop => Ok(String::new()),
